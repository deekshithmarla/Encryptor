...
public class DeeksEncryptor extends JFrame {
	...
	private class EncryptHandler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			try {
				...
				// file
				int returnVal = fc.showSaveDialog(DeeksEncryptor.this);
	...
	public class openFileHandler implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			try {
				int returnVal = fc.showOpenDialog(DeeksEncryptor.this);
